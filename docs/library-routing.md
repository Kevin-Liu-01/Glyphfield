...
| Composable shader scenes | [Shaders.com](https://shaders.com/) | Evaluated, but not shipped: its license prohibits redistribution in a competing design editor. Glyphfield instead uses original local GLSL recipes for the ten scene families cataloged in Ariadne. |
