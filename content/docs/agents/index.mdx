...
Use the Studio when a task requires Canvas, WebGL, local fonts, local images, visual placement, high-resolution PNG rasterization, GIF capture, or exact source edits to an active browser artifact. Browser-capable agents can open **Code**, apply validated source, inspect the resulting canvas, and continue with visual controls.
