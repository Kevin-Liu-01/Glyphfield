...
Ordinary Design Lab Pause and PNG/JPG/GIF/MP4 exports do not create captured-frame assets. **Capture shader frame** explicitly stores a lossless PNG checkpoint with the editable shader recipe; named saves and portable source can retain these checkpoints. Playback and extending the time explorer do not continually encode or save new shader frames.
