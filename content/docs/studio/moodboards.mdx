...
Board source configures presentation and output only. Identity content, assets, fonts, and art direction continue to come from Brand settings. See [Source code editing](/docs/studio/source-editing) for the shared Apply and Reset behavior.
