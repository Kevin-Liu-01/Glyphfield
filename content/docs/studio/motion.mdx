...
- Choose output width, quality, frame rate, and duration; the active artboard's aspect ratio is preserved, including portrait presets and custom dimensions.
