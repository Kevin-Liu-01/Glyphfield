...
Glyphfield includes three focused motion systems: frame-based Animation, a dedicated Lottie editor, and Material for live WebGL motion. Animation and Material share the same [Shader Library](/docs/studio/shader-library), palettes, and live-material settings.
...
Material applies live WebGL motion to the background, the alpha-masked logo, or both. Its resizable Shader Library opens by default as a second sidebar; selecting a preview updates the main canvas and exposes shared controls and live surface finishes beside it. Surface Lab is the static SVG-background counterpart.
