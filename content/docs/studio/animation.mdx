...
New, Save, Fork, and Clone sit beside the artboard picker and size settings on the left of the artboard bar; add, duplicate, and delete are grouped on the right. Open saved animations from the version-history control beside the canvas view controls. The top header groups source and reset on the left, with export actions on the right.
