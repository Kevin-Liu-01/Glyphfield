...
New, Save, Fork, and Clone sit beside the artboard picker and size settings on the left of the artboard bar; add, duplicate, and delete are grouped on the right. Undo, Redo, Action history, and the compact Saved animations control sit together in the canvas dock. The header shows the autosaved draft or saved animation name immediately before exports, with Open project file, Download project file, and source code alongside them.
