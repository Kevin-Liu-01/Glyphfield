...
<DocsMediaGrid>
  <DocsMedia alt='General Translation component library in dark Studio chrome' caption='Dark component sheet' meta='Identity-aware states' src='/screenshots/studio-gt-components-dark-2026.png' />
  <DocsMedia alt='General Translation component library in light Studio chrome' caption='Light component sheet' meta='Same component contract' src='/screenshots/studio-gt-components-light-2026.png' />
</DocsMediaGrid>
...
See [Editor systems and plugins](/docs/studio/editor-systems) for each component's states, state owner, reuse map, and third-party provider boundary, or [Source code editing](/docs/studio/source-editing) for the shared drawer workflow.
