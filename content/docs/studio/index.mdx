...
Every generator uses the same [editor systems](/docs/studio/editor-systems) for color, canvas zoom, selection, layers, alignment, assets, persistent drafts, and source editing. This makes an interaction learned in one tool available everywhere it applies.
...
| Boards | Moodboard |
| Motion | Animation, Lottie, Material |
