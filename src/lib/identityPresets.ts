...
const RAMP_BRAND_IDENTITY: BrandIdentity = {
  ...RAMP_SYSTEM,
  applications: [
...
const MINTLIFY_BRAND_IDENTITY: BrandIdentity = {
  ...MINTLIFY_SYSTEM,
  applications: [
...
const TAILWIND_BRAND_IDENTITY: BrandIdentity = {
  ...TAILWIND_SYSTEM,
...
const VITEPLUS_BRAND_IDENTITY: BrandIdentity = {
  ...VITEPLUS_SYSTEM,
...
const CLOUDFLARE_BRAND_IDENTITY: BrandIdentity = {
  ...CLOUDFLARE_SYSTEM,
...
const STRIPE_BRAND_IDENTITY: BrandIdentity = {
  ...STRIPE_SYSTEM,
...
export const BASEMENT_BRAND_IDENTITY: BrandIdentity = {
  ...
  typography: [
    { family: 'Basement Grotesque', fontId: 'basement-grotesque-black', letterSpacing: -1, lineHeight: 0.98, role: 'Display', usage: 'Large, compact statements with clear spacing between letters and lines', weight: 550 },
