...
function asset(
  ...
  return { id, label, path, surface, type, usage };
}
...
export const GT_BRAND_IDENTITY: BrandIdentity = {
  ...
  assets: [
    ...
    asset('reference-homepage', 'GT homepage · July 2026', '/brands/gt/references/homepage-2026.png', 'any', 'image', 'Official homepage reference for monochrome layout, product language, navigation, and proof.'),
  ],
...
export const RAMP_BRAND_IDENTITY: BrandIdentity = {
  ...
  assets: [
    ...
    asset('reference-homepage', 'Ramp homepage · July 2026', '/brands/ramp/references/homepage-2026.png', 'any', 'image', 'Official homepage reference for savings-led hierarchy, product photography, warm paper, and highlighter color.'),
  ],
...
export const MINTLIFY_BRAND_IDENTITY: BrandIdentity = {
  ...
  assets: [
    ...
    asset('reference-homepage', 'Mintlify homepage · July 2026', '/brands/mintlify/references/homepage-2026.png', 'any', 'image', 'Official homepage reference for dark knowledge surfaces, editorial serif hierarchy, and restrained mint signal.'),
  ],
...
export const BASEMENT_BRAND_IDENTITY: BrandIdentity = {
  ...
  assets: [
    ...
    asset('reference-homepage', 'Basement homepage · July 2026', '/brands/basement/references/homepage-2026.png', 'any', 'image', 'Official homepage reference for project-specific worlds, tactile darkness, deliberate low fidelity, and one strong visual move.'),
  ],
