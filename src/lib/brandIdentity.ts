...
export const GT_BRAND_IDENTITY: BrandIdentity = {
  ...
  builtIn: true,
  colors: [
    { hex: '#18181B', id: 'ink', name: 'Ink', role: 'Primary text and dark surfaces' },
    { hex: '#FFFFFF', id: 'paper', name: 'Paper', role: 'Base background' },
    { hex: '#F4F4F5', id: 'muted', name: 'Muted', role: 'Quiet surfaces and secondary controls' },
    { hex: '#3B82F6', id: 'emphasis', name: 'Emphasis blue', role: 'Focus, selection, and primary emphasis' },
    { hex: '#16A34A', id: 'success', name: 'Success green', role: 'Completed and healthy status' },
    { hex: '#F59E0B', id: 'warning', name: 'Warning amber', role: 'Attention and warning status' },
    { hex: '#F97316', id: 'progress', name: 'Progress orange', role: 'Active and in-progress status' },
    { hex: '#EF4444', id: 'error', name: 'Error red', role: 'Destructive and error states' },
  ],
  description:
