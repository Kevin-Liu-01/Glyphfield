...
export const GT_SYSTEM: BrandSystemSource = {
  ...
  dossier: {
    ...
    renderingRecipe: ['Begin with a deep black or exact white field', 'Add one soft gradient, fine dither, or matte plane', 'Use slight corner radii only where a surface needs a finished edge', 'Keep highlights broad and quiet rather than chrome-like', 'Set Switzer display type against quiet Rasmus Inter support', 'Keep the GT mark isolated with generous clear space', 'Use gray as light rather than a decorative color'],
...
export const RAMP_SYSTEM: BrandSystemSource = {
  ...
  dossier: {
    applications: ['Savings proof', 'Finance operations dashboard', 'Corporate card', 'Benchmark report', 'Product workflow', 'Finance event system'],
    ...
    imagery: 'Use real product UI, corporate cards, receipts, ledgers, and financial artifacts. Center standalone product evidence; reserve people-free diagrams, materials, and quiet financial fields for backgrounds.',
    ...
    provenance: 'Official Ramp product, press, and logo sources remain research or proof material. Every external image requires an explicit source and redistribution status.',
  ...
  references: referencePack('ramp', {
    ...
    campaign: ['Finance benchmark report', 'Product workflow campaign', 'Product launch evidence', 'Finance event environment'],
...
export const STRIPE_SYSTEM: BrandSystemSource = {
  ...
  references: referencePack('stripe', {
    ...
    campaign: ['Internet economy story', 'Product object campaign', 'Global payments expansion', 'Developer integration campaign'],
